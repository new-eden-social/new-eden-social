...
import { IAuthenticateGrpcService, IVerifyDecodeRequest,
  IVerifyDecodeResponse, IAuthenticateRequest,
  IAuthenticateResponse } from '@new-eden-social/services-authenticate/grpc/authenticate.grpc.interface';
